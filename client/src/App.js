...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      this.setState({loaded:true, tokenSaleAddress:MintedCrowdsale.networks[this.networkId].address}, this.updateUserTokens);
    } catch (error) {
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <p>Total supply of tokens is: {this.state.totalSupply}</p>
